          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Explore the vibrant world of colors with our beautifully crafted
                design elements. Blue, Red, Green, and White - the perfect
                palette for your next project.
              </p>
              <div className="flex flex-col sm:flex-row justify-center md:justify-start gap-4">
                ...
                <Button
                  asChild
                  variant="outline"
                  className="border-brandRed text-brandRed hover:bg-brandRed/10"
                >
      ...
      <section className="py-20 px-6 md:px-12 bg-gradient-to-br from-brandBlue/5 to-brandGreen/5">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Sizin ağıllı köməkçiniz - suallar verin, idealar alın, məsləhətlər
            əldə edin
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-sm text-muted-foreground">
                Yaradıcı həllər və innovativ fikirlər üçün AI köməkçisindən
                istifadə edin
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-4">
                ...
                <p className="text-gray-600">
                  Process transactions quickly with our intuitive interface.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-4">
                ...
                <p className="text-gray-600">
                  Track your stock in real-time with automatic updates.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-4">
                ...
                <p className="text-gray-600">
                  Comprehensive analytics to help grow your business.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-card p-8 rounded-lg shadow-md">
              ...
              <p className="text-muted-foreground">
                Our designs look great on all devices, from desktop to mobile.
              </p>
            </div>
            ...
            <div className="bg-card p-8 rounded-lg shadow-md">
              ...
              <p className="text-muted-foreground">
                Carefully selected colors that work together to create a
                cohesive experience.
              </p>
            </div>
            ...
            <div className="bg-card p-8 rounded-lg shadow-md">
              ...
              <p className="text-muted-foreground">
                Optimized code and assets for quick loading and smooth
                interactions.
              </p>
            </div>
          </div>
