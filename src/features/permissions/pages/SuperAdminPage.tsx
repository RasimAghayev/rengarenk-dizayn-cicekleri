      ...
      <div className="space-y-6">
        ...
        <Alert className="bg-amber-50 border-amber-200">
          ...
          <AlertDescription className="text-amber-600">
            This area is restricted to super administrators only. Changes made
            here affect the entire system.
          </AlertDescription>
        </Alert>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="bg-gradient-to-br from-purple-50 to-white border-purple-100">
            ...
            <CardContent>
              ...
              <Progress
                value={Math.min(stats.totalUsers * 5, 100)}
                className="h-1 mt-2"
              />
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-blue-50 to-white border-blue-100">
            ...
            <CardContent>
              ...
              <Progress
                value={Math.min(stats.totalRoles * 10, 100)}
                className="h-1 mt-2"
              />
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-emerald-50 to-white border-emerald-100">
            ...
            <CardContent>
              ...
              <Progress
                value={Math.min(stats.totalPermissions * 5, 100)}
                className="h-1 mt-2"
              />
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-amber-50 to-white border-amber-100">
            ...
            <CardContent>
              ...
              <Progress
                value={Math.min(stats.totalAssignments * 2, 100)}
                className="h-1 mt-2"
              />
            </CardContent>
          </Card>
