...
export const categories: Category[] = [
  ...
  },
  {
    id: 2,
    name: "Electronics",
    icon: React.createElement(Grid3X3, { size: 20 }),
  },
...
export const products: Product[] = [
  {
    ...
    quantity: 0,
    description:
      "High-quality electronic product with excellent performance and durability.",
  },
  {
    id: 2,
    name: "Product B",
  ...
  },
  {
    ...
    quantity: 0,
    description:
      "Comfortable and stylish clothing item made with premium materials.",
  },
  {
    id: 5,
    name: "Product E",
    ...
    quantity: 0,
    description:
      "Special grocery item currently on discount with excellent quality.",
  },
];
